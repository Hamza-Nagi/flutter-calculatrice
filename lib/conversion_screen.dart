...
import 'package:scientific_calculator_master/conversion_logic/time_conversion_widget.dart';
import 'package:scientific_calculator_master/conversion_logic/weight_conversion_widget.dart';
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => WeigthConversionScreen()),
              );
            },
          ),
        ],
